        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building intelligent systems leveraging cutting-edge machine learning models, from LLM integrations to computer vision applications.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Designing robust data pipelines, scalable model deployments, and efficient semantic search architectures for production AI flows.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Model Ops</div>
